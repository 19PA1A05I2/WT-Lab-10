...
$qry1 = "INSERT INTO users_tbl (`Name`, `Email`, `Password`,`PhoneNumber`) VALUES
...
if($res1){
    ...
    echo ("Information not inserted. Please Try again");
}
}
$qry2="SELECT * FROM `users_tbl`";
